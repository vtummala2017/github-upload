...
public class Main {
	...
	public void runScript(){
	       Process process;
	       try{
	             process = Runtime.getRuntime().exec(new String[]{"/Users/vijayanthtummala/Downloads/aquaplanning-master/src/main/java/edu/kit/aquaplanning/pddl-parser-master/PDDLexec.command","/Users/vijayanthtummala/Downloads/aquaplanning-master/src/main/java/edu/kit/aquaplanning/pddl-parser-master/trydomain.pddl","/Users/vijayanthtummala/Downloads/aquaplanning-master/src/main/java/edu/kit/aquaplanning/pddl-parser-master/tryproblem.pddl"});
	             mProcess = process;
	       }catch(Exception e) {
...
private static void mcall(String[] args) throws IOException {
	...
	public static void main(String[] args) throws Exception {
		...
		//args[1]="/Users/vijayanthtummala/Downloads/aquaplanning-master/MyStateFiles/filename18.pddl";
	    ...
	    Scanner inFile1 = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master/pddl-parser-master/iplist.txt")).useDelimiter(",\\s*");
	 ...
	 // create token1
	    ...
	    // create Scanner inFile1
	    Scanner inFile2 = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master/pddl-parser-master/IdentifiedRoomList.txt")).useDelimiter(",\\s*");
	 ...
	 // create token1
	    ...
	    // create Scanner inFile1
	    Scanner inFile3 = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master/pddl-parser-master/KeyPredicatesForInterdependence.txt")).useDelimiter(",\\s*");
	    ...
	    // create Scanner inFile1
	    Scanner inFile4 = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master/pddl-parser-master/KnownActorTypeList.txt")).useDelimiter(",\\s*");
		...
		/*String pythonScriptPath = "/Users/vijayanthtummala/Downloads/aquaplanning-master/src/main/java/edu/kit/aquaplanning/pddl-parser-master/PDDL.py"; // /Users/vijayanthtummala/Downloads/aquaplanning-master/src/main/java/edu/kit/aquaplanning/pddl-parser-master/trydomain.pddl /Users/vijayanthtummala/Downloads/aquaplanning-master/src/main/java/edu/kit/aquaplanning/pddl-parser-master/tryproblem.pddl";
		String[] cmd = new String[4];
		cmd[0] = "python"; // check version of installed python: python -V
		cmd[1] = pythonScriptPath;
		cmd[2] = "/Users/vijayanthtummala/Downloads/aquaplanning-master/src/main/java/edu/kit/aquaplanning/pddl-parser-master/trydomain.pddl";
		cmd[3] = "/Users/vijayanthtummala/Downloads/aquaplanning-master/src/main/java/edu/kit/aquaplanning/pddl-parser-master/tryproblem.pddl";
		...
		try {
			...
			Process p = Runtime.getRuntime().exec("python /Users/vijayanthtummala/Downloads/aquaplanning-master/src/main/java/edu/kit/aquaplanning/pddl-parser-master/PDDL.py Users/vijayanthtummala/Downloads/aquaplanning-master/src/main/java/edu/kit/aquaplanning/pddl-parser-master/trydomain.pddl /Users/vijayanthtummala/Downloads/aquaplanning-master/src/main/java/edu/kit/aquaplanning/pddl-parser-master/tryproblem.pddl");
		...
		/*
			...
			*/
		    ...
		    int tex2= 0;
			FileWriter myCWriter2 = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master/check.txt");
		    ...
		    int tex4=0;
		    FileWriter myWriter3 = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master/shareddatausedcount.txt");
		    myWriter3.write(new Integer(tex4).toString());
		    myWriter3.close();
		    System.out.println("Successfully wrote to the file.");
		    
		    int tex6=0;
		    FileWriter myWriter5 = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master/shareddatausedcountrobotrelated.txt");
		    myWriter5.write(new Integer(tex6).toString());
		    myWriter5.close();
		    System.out.println("Successfully wrote to the file.");
		    
		    int tex5=0;
		    FileWriter myWriter4 = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master/FinalSolution/froomfadddatacheckExit.txt");
		    myWriter4.write(new Integer(tex5).toString());
		    myWriter4.close();
		    System.out.println("Successfully wrote to the file.");
		    
		    FileWriter myWriter = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master/FinalSolution/finalstepitaration.txt");
		      myWriter.write("");
		      myWriter.close();
		      System.out.println("Successfully wrote to the file.");
		      
		      FileWriter myWriter7 = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master/FinalSolution/finalstepitarationOnlyHimself.txt");
		      myWriter7.write("");
		      myWriter7.close();
		      System.out.println("Successfully wrote to the file.");
		      
		      FileWriter myWriter2 = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master/FinalSolution/finalstepitarationOnlySteps.txt");
		      myWriter2.write("");
		      myWriter2.close();
		      System.out.println("Successfully wrote to the file.");
		      
		      int t =0;
		      FileWriter myWriter8 = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master/dataexchangecount.txt");
		      myWriter8.write(new Integer(t).toString());
		      myWriter8.close();
		      System.out.println("Successfully wrote to the file.");
		      
		      int ts =0;
		      FileWriter myWriter9 = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master/TotalSleepTime.txt");
		      myWriter9.write(new Integer(ts).toString());
		      myWriter9.close();
		      System.out.println("Successfully wrote to the file.");
		      
		      int l =0;
		      FileWriter myWriter10 = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master/NumberofAllData.txt");
		      myWriter10.write(new Integer(l).toString());
		      myWriter10.close();
		      System.out.println("Successfully wrote to the file.");
		      
		      int l1 =0;
		      FileWriter myWriter101 = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master/ReadTimesData.txt");
		      myWriter101.write(new Integer(l1).toString());
		      myWriter101.close();
		      System.out.println("Successfully wrote to the file.");
		      
		      /*FileWriter myWriter6 = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master/R1toR2/StatePredicatesSent.txt");
		      myWriter6.write("");
		      myWriter6.close();
		      System.out.println("Successfully wrote to the file.");
		      
		      FileWriter myWriter7 = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master/R1toR2/ObjectSent.txt");
		      myWriter7.write("");
		      myWriter7.close();
		      System.out.println("Successfully wrote to the file.");*/
		...
		Scanner scannerts = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master/TotalSleepTime.txt"));
		...
		scannerts.close();
		FileWriter myWriter81 = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master/TotalSleepTime.txt");
		myWriter81.write(new Integer(x1).toString());
		myWriter81.close();
		System.out.println("Successfully wrote to the file.");
		
		
		String path="/Users/vijayanthtummala/Downloads/aquaplanning-master/MyStateFiles/";
		...
		/*String cmd = "python /Users/vijayanthtummala/Downloads/aquaplanning-master/src/main/java/edu/kit/aquaplanning/pddl-parser-master/PDDL.py /Users/vijayanthtummala/Downloads/aquaplanning-master/src/main/java/edu/kit/aquaplanning/pddl-parser-master/trydomain.pddl /Users/vijayanthtummala/Downloads/aquaplanning-master/src/main/java/edu/kit/aquaplanning/pddl-parser-master/tryproblem.pddl";
		...
		*/
		...
		//args[0]="/Users/vijayanthtummala/Downloads/trydomain.pddl";
		//args[1]="/Users/vijayanthtummala/Downloads/aquaplanning-master/MyStateFiles/filename0.pddl";
		int temp=0;
		while (hasNext)
		{
		    
		    	Scanner scannertss = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master/filecount.txt"));
		...
		scannertss.close();
		FileWriter myWriter81s = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master/filecount.txt");
		myWriter81s.write(new Integer(x1s).toString());
		myWriter81s.close();
		System.out.println("Successfully wrote to the file.");
		
			String filePath = path+fileprefix+String.valueOf(i)+fileType;
			args[0]="/Users/vijayanthtummala/Downloads/aquaplanning-master/trydomain.pddl";
			args[1]=filePath;
			...
			if(f.exists() && !f.isDirectory()) { 
				...
				try {
					...
					Scanner sc = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master/observedexitcheck.txt"));
