...
class PDDL_Parser:
    ...
    def parse_problem(self, problem_filename):
        ...
        global v_goal #adding the goals with ?r - room etc
        v_goal=[]
        if type(tokens) is list and tokens.pop(0) == 'define':
...
if __name__ == '__main__':
    ...
    file1 = open('/Users/vijayanthtummala/Downloads/aquaplanning-master/src/main/java/edu/kit/aquaplanning/pddl-parser-master/Goal.txt', 'w')
        #L = ["This is Delhi \n", "This is Paris \n", "This is London \n"]
        #s = "Hello\n"
    ...
    # acl has moves and effect
     ...
     #--------------------------end Removing unwanted characters--------------#      
        ...
        ##start of extracting robot related details 09/15/2021
        robotdetails = []
        robotdetailsstr=""
        print("TODAY")
        concrob= "'"+actor_type_we_know[0]+"'"
        for i in initstate:
            if concrob in str(i):
                robotdetailsstr =  str(i)
                print(i)
        ##robotdetailsstr = robotdetailsstr.split(",")
        robotdetailsstr = robotdetailsstr.replace("'","")
        robotdetailsstr = robotdetailsstr.replace(" ","")
        robotdetailsstr = robotdetailsstr.replace(")","")
        robotdetailsstr = robotdetailsstr.replace("(","")
        robotdetailsstr = robotdetailsstr.replace("]","")
        robotdetailsstr = robotdetailsstr.replace("[","")
        robotdetails = robotdetailsstr.split(",")
        #robotdetails.append(robotdetailsstr)
        
        print(robotdetails)
        for i in robotdetails:
            print(i)
        print("TODAY")
        
        file1 = open('/Users/vijayanthtummala/Downloads/aquaplanning-master/src/main/java/edu/kit/aquaplanning/pddl-parser-master/robotselfdata.txt', 'w')
        #L = ["This is Delhi \n", "This is Paris \n", "This is London \n"]
        #s = "Hello\n"
        ...
        ##end of extracting robot related details 09/15/2021
        ...
        #print("print XXXXXXX: ", actor_type_we_know)
        ...
        print("Lets Try our best")
        print(v_goal)
        split_v_goal =[]
        sg=[]
        for v in v_goal:
            split_v_goal = str(v).split("[")
            #print(v)
        
        for v in split_v_goal:
            if "?" in str(v):
                x = str(v).replace("'", "")
                x = x.replace("]", "")
                sg.append(x)
        ...
        print()
        tr=[]
        NewListsg= [[x] for x in sg]
        print(NewListsg)
        
        #list(map(lambda el:[el], NewListsg[0]))
        #print(NewListsg[0][0])
        ...
        for x in range (l):
            p.append(str(NewListsg[x][0]).split(", "))
        ...
        file1 = open('/Users/vijayanthtummala/Downloads/aquaplanning-master/src/main/java/edu/kit/aquaplanning/pddl-parser-master/GoalAndTypes.txt', 'w')
        #L = ["This is Delhi \n", "This is Paris \n", "This is London \n"]
        #s = "Hello\n"
        ...
        res.append(sub)
        print(res)'''
        #smallerlist = [l.split(',') for l in ','.join(sg).split(',')]    
        '''for c in chunk:
            print(c)'''
        #for i in r_names:
