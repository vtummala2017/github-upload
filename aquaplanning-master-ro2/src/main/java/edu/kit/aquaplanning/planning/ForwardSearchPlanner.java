	...
	public Plan findPlan(GroundPlanningProblem problem) {
	 ...
	 // create token1
	    ...
	    try
	    {
		    ...
		    Scanner gt = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/src/main/java/edu/kit/aquaplanning/pddl-parser-master/GoalAndTypes.txt")).useDelimiter("[;\\r\\n]");
	    ...
	    // create Scanner inFile1
	    Scanner inFile1 = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/src/main/java/edu/kit/aquaplanning/pddl-parser-master/iplist.txt")).useDelimiter("[;\\r\\n]");
	    ...
	    inFile1.close();
	     ...
	     // create Scanner inFile1
	    Scanner inFile11 = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master/src/main/java/edu/kit/aquaplanning/pddl-parser-master/robotselfdata.txt")).useDelimiter("[;\\r\\n]");
	 ...
	 // for-each loop for calculating heat index of May - October
	    ...
	    // create Scanner inFile1
	    Scanner inFile2 = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/src/main/java/edu/kit/aquaplanning/pddl-parser-master/IdentifiedRoomList.txt")).useDelimiter("[;\n]");
		...
		while (withinComputationalBounds(iteration) && !frontier.isEmpty()) {
			...
			if (goal.isSatisfied(node.state)) {
				...
				while (node != null && node.lastAction != null) {
				    ...
				    if (node.lastAction.getName().contains("robot2"))
					{
						ourplan.add(node.lastAction.getName());
						SMMStates.add(problem.stateToString(node.state));
					...
					state_init = "(:init \n (ROOM rooma)  (ROOM roomb) (ROOM roomc) (ROOM roomd) (ROOM roome) (ROOM roomf) \n" + 
							...
							"        (ROBOT robot2) (ROBOT robot2) \n" + state_init+ "\n ) \n";
					try {
					      FileWriter myWriter = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/filename.pddl");
					...
					try {
					      FileWriter myWriter = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/finalstepitaration.txt");
				...
				try {
					...
					Scanner sc = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/check.txt"));
				...
				try {
					...
					Scanner sc = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/shareddatausedcountrobotrelated.txt"));
			    ...
			    // create Scanner inFile1
			    //Scanner inFile1 = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/tryproblemnew.pddl")).useDelimiter(",\\s*");
			    Scanner inFile1 = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/src/main/java/edu/kit/aquaplanning/pddl-parser-master/tryproblemnewtestr1.pddl")).useDelimiter(",\\s*");
				...
				if(ourplan.size()>0 && tll[0]==0) {
					...
					try {
						tll[0]=1;
						myCW = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/check.txt");
				...
				//for (int i = 0; i < ourplan.size(); i ++) {
				    ...
				    // create Scanner inFile1
				    //Scanner if1 = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master/R1toR2/ObjectSent.txt")).useDelimiter("\n");
				    Scanner if1 = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master/R1toR2/ObjectSent.txt"));
                ...
                //Thread.sleep(1000);
				    ...
				    Scanner if2 = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master/R1toR2/StatePredicatesSent.txt")).useDelimiter(",\\s*");
					...
					try {
					      ...
					      File myObj = new File("/Users/vijayanthtummala/Downloads/aquaplanning-master/R1toR2/StatePredicatesSent.txt");
					...
					/*
					File myObj = new File("/Users/vijayanthtummala/Downloads/aquaplanning-master/R1toR2/ObjectSent.txt"); 
					    if (myObj.delete()) { 
					    ...
					    File myObj1 = new File("/Users/vijayanthtummala/Downloads/aquaplanning-master/R1toR2/StatePredicatesSent.txt"); 
					    if (myObj1.delete()) { 
					...
					try {
						...
						Scanner sc = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/shareddatausedcount.txt"));
					...
					try {
						//tll[0]=0;
						myCW = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/shareddatausedcount.txt");
					...
					if(shareddatausedcountrl ==0)
					{
						...
						try {
							//tll[0]=0;
							myCW = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/shareddatausedcountrobotrelated.txt");
					...
					*/
					...
					try {
						...
						Scanner scanner = new Scanner(new File("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/counter.txt"));
						...
						myCWriter = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/counter.txt");
					...
					if (counter==0) {
						...
						if (sendData==true)
						{
							...
							finalstrsendData = finalstrsendData + "(visited roomh)";
							...
							try
							{
									FileWriter room = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/R1toR2/RoomData.txt");
									//FileWriter myWriter = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/tryproblem.pddl");
									room.write(finalRoomSend);
									room.close();
							      
							      
									FileWriter r_object = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/R1toR2/ObjectSent.txt",false);
									//FileWriter myWriter = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/tryproblem.pddl");
									r_object.write(finalstrsendDatablock);
									r_object.close();
									
									FileWriter st_Data = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/R1toR2/StatePredicatesSent.txt",false);
									//FileWriter myWriter = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/tryproblem.pddl");
						...
						//{
							try {
							      FileWriter myWriter = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/MyStateFiles/filename" + tall[0]+".pddl");
								//FileWriter myWriter = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/tryproblem.pddl");
							      myWriter.write( state_domain + state_object + state_init + state_goal);
							      myWriter.close();
							      FileWriter myWriter3 = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/TestMyStateFiles/filename" + tall[0]+".pddl");
									//FileWriter myWriter = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/tryproblem.pddl");
					...
					try {
					      ...
					      FileWriter myWriter = new FileWriter("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/FinalSolution/finalstepitaration.txt",true);
					      //myWriter.write("\n" +ourplan.get(i) + " \n" + SMMStates.get(i) );
					      myWriter.write("\n" +ourplan.get(i));
					      myWriter.close();
					      System.out.println("Successfully wrote to the file.");
					...
					//Main temp = new Main();
					//String[] args = new String() {"/Users/vijayanthtummala/Downloads/trydomain.pddl", "/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/filename\" + counter+\".pddl"};
					...
					//mainCopy(drinks);
					//plan.appendAtFront("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/filename" + counter+".pddl");
					...
					/*
					 try {
		                        	ProcessBuilder pb = new ProcessBuilder("/bin/bash","/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/target/try.sh");
                                    Process p = pb.start();
		                        } catch (IOException e) {
		                    	// TODO Auto-generated catch block
		                    	e.printStackTrace();
		                        }*/
						//mcall("/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/trydomain.pddl","/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/MyStateFiles/filename" + tall[0]+".pddl");
				...
				//String drinks[] = {"/Users/vijayanthtummala/Downloads/trydomain.pddl", "/Users/vijayanthtummala/Downloads/aquaplanning-master-ro2/filename" + 0+ ".pddl"};
				//Main.main(drinks);
				//ForwardSearchPlanner f = new ForwardSearchPlanner();
				//mainCopy(drinks);
